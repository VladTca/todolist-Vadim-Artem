...
type TodolistPropsType = {
    ...
    onClickSomthing: (value: string) => void
}
...
export const Todolist = ({onClickSomthing, title, tasks, removeTask, addTask, changeTaskStatus}: TodolistPropsType) => {
    ...
    const onClickFilterHandler = (value: string) => onClickSomthing(value);
